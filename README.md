...
- Oct./22: [Functional Programming]
- Oct./24: [OOP]
- Oct./29: [OOP]
- Oct./31: [Python Objects]
- In-class Quiz 5: []
- Nov./05: [Python Objects]
- Nov./07: [Testing, debugging, Tuning]
- Nov./12: [Testing, debugging, Tuning]
- Nov./14: [Algorithms in Python]
- Final Project: []
- Nov./21 [Algorithms in Python]
- Nov./26 [Python in Data Science]
- Nov./28 [Python in Geometry Processing]
